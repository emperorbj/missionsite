        ...
        <>
            ...
            <section className="md:mt-40 lg:mt-0">
                <div className=" font-myFont md:mt-40 lg:mt-0">
                    <h1 className='mt-[4rem] md:mt-80 text-center font-playWrite text-3xl font-bold md:mb-5 lg:mb-0 lg:mt-40'>HERE ARE OUR PAST BLOGS</h1>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-3 lg:gap-10 md:p-5 lg:p-10">
                        <div className="bg-white mx-4 md:mx-0 flex flex-col gap-3 md:w-[270px] lg:w-[470px] rounded-[8px]">

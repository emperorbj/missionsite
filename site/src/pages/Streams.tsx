...
//                         {/* image container */}
//                         <div className="h-[100%]">
//                             <ReactPlayer className="object-cover" width={600} height={430} light url="https://www.youtube.com/watch?v=S7WBEJJlYWU"/>
//                         </div>
...
//                                 <ReactPlayer className="object-cover" width={300} height={190} light url="https://www.youtube.com/watch?v=DB18or8bJ10" />
//                             </div>
//                         </div>
//                         <div className=" flex h-[45%]">
//                             <div className="w-[65%] h-[100%] flex flex-col justify-center gap-3 px-[15px]">
...
//                             </div>
//                             <div className="w-[50%] h-[100%]">
//                                 <ReactPlayer className="object-cover" width={300} height={190} light url="https://www.youtube.com/watch?v=1tVO0-zYAvE" />
//                             </div>
//                         </div>
//                     </div>
//                 </div>
...
//                                 <ReactPlayer className='object-cover' width={450} height={350} light url="https://www.youtube.com/watch?v=ozQ768oUQ4c"/>
//                             </div>
...
//                         <div className=" w-[470px]  rounded-[8px] flex flex-col gap-3">
//                             <div className="h-[300px]">
//                                 <ReactPlayer className='object-cover' width={450} height={350} light url="https://www.youtube.com/watch?v=VShB2Y6A5Kc"/>
//                             </div>
//                             <div className="w-[100%] h-[160px] flex flex-col gap-5 items-center justify-center">
...
//                         <div className=" w-[470px] rounded-[8px] flex flex-col gap-3">
//                             <div className="h-[300px]">
//                                 <ReactPlayer className='object-cover' width={450} height={350} light url="https://www.youtube.com/watch?v=vEwB7GrvdXI" />
//                             </div>
//                             <div className="w-[100%] h-[160px] flex flex-col gap-5 items-center justify-center">
...
//                         <div className=" w-[470px] rounded-[8px] flex flex-col gap-3">
//                             <div className="h-[300px]">
//                                 <ReactPlayer className='object-cover' width={450} height={350} light url="https://www.youtube.com/watch?v=6Jd6aHz9BrQ" />
//                             </div>
//                             <div className="w-[100%] h-[160px] flex flex-col gap-5 items-center justify-center">
...
//                         <div className=" w-[470px] rounded-[8px] flex flex-col gap-3">
//                             <div className="h-[300px]">
//                                 <ReactPlayer className='object-cover' width={450} height={350} light url="https://www.youtube.com/watch?v=u9ELpG9T0h0" />
//                             </div>
//                             <div className="w-[100%] h-[160px] flex flex-col gap-5 items-center justify-center">
...
//                         <div className=" w-[470px] rounded-[8px] flex flex-col gap-3">
//                             <div className="h-[300px]">
//                                 <ReactPlayer className='object-cover' width={450} height={350} light url="https://www.youtube.com/watch?v=BGMwWQO_NzY" />
//                             </div>
//                             <div className="w-[100%] h-[160px] flex flex-col gap-5 items-center justify-center">

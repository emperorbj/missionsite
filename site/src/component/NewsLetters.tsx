...
const NewsLetters = () => {
    return (
            <div className="relative isolate overflow-hidden bg-slate-400 py-16 sm:py-24 lg:py-32">
    <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="max-w-xl lg:max-w-lg">
            ...
            <button type="submit" className="flex-none rounded-md bg-sky-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Subscribe</button>
            </div>
        </div>
    ...
    <div className="absolute left-1/2 top-0 -z-10 -translate-x-1/2 blur-3xl xl:-top-6" aria-hidden="true">
        <div className="aspect-[1155/678] w-[72.1875rem] bg-gradient-to-r from-slate-50 to-sky-500  opacity-30" style={{
